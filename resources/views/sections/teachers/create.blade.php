...
@section('content')
    <div class="container">
        <div class="card">
            <div class="card-body">
                <form  class=" "  >
                    <h1>Registro @extends('layouts.app')
                    @section('content')
                        <div class="container">
                            <div class="card">
                                <div class="card-body">
                                    <form action="{{ route('teacher.store') }}" class=" " method="POST">
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                ...
                                                <input type="text"
                                                    class="form-control @error('rut') is-invalid @enderror" id="rut"
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-12 text-center">
                                                <button type="submit" class="btn btn-primary"> <i
                                                        class="bi bi-plus-circle"> Guardar</i>
                                                </button>
                                            </div>
